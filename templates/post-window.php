        ...
        <div class="post-details__wrapper post-photo">
            <div class="post-details__main-block post post--details">
                <?php switch ($post['type']) {
                    case 'post-photo':
                        echo include_template('post-window-types/post-photo.php', ['post' => $post]);
                        break;
                    case 'post-video':
                        echo include_template('post-window-types/post-video.php', ['post' => $post]);
                        break;
                    case 'post-quote':
                        echo include_template('post-window-types/post-quote.php', ['post' => $post]);
                        break;
                    case 'post-text':
                        echo include_template('post-window-types/post-text.php', ['post' => $post]);
                        break;
                    case 'post-link':
                        echo include_template('post-window-types/post-link.php', ['post' => $post]);
                        break;
                }
                ?>
