            ...
            <li class="post-mini post-mini--photo post user">
                <div class="post-mini__user-info user__info">
                    <div class="post-mini__avatar user__avatar">
                        <a class="user__avatar-link" href="#">
                            <img class="post-mini__picture user__picture" src="<?= get_user_avatar($post['avatar']) ?>"
                    ...
                    <div class="post-mini__name-wrapper user__name-wrapper">
                        ...
                        <time class="post-mini__time user__additional" datetime="2014-03-20T20:20"><?= show_past_time(
                                $post['dt_add']
                            ) ?></time>
                    </div>
                </div>
                <div class="post-mini__rating user__rating">
                    ...
                    <p class="post-mini__rating-item user__rating-item user__rating-item--subscribers">
                        <span
                            class="post-mini__rating-amount user__rating-amount"><?= $post['subscribers_count'] ?></span>
                        <span class="post-mini__rating-text user__rating-text"><?= get_noun_plural_form(
