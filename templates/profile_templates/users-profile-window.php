            ...
            <div class="profile__user user container">
                <div class="profile__user-info user__info">
                    <div class="profile__avatar user__avatar">
                        <img class="profile__picture user__picture" src="<?= get_user_avatar($this_user['avatar']) ?>"
            ...
            <div class="container">
                <div class="profile__tabs filters">
                    ...
                    <ul class="profile__tabs-list filters__list tabs__list">
                        ...
                        <li class="profile__tabs-item filters__item">
                            <?php
                            $classname = $tab === 'subscribes' ? 'filters__button--active' : ''; ?>
                            <a class="profile__tabs-link filters__button tabs__item button <?= $classname ?>"
                    ...
                    switch ($tab) {
                        case 'posts':
                            echo include_template(
                                'profile_templates/users-window-types/users-posts.php',
                                ['posts' => $posts, 'connection' => $connection]
                            );
                            break;
                        case 'likes':
                            echo include_template(
                                'profile_templates/users-window-types/users-likes.php',
                                ['posts' => $posts]
                            );
                            break;
                        case 'subscribes':
                            echo include_template(
                                'profile_templates/users-window-types/users-subscribes.php',
                                ['posts' => $posts, 'user' => $user, 'connection' => $connection]
                            );
                            break;
                    }
                    ?>
