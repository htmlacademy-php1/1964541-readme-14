    ...
    <ul class="messages__contacts-list tabs__list">
        ...
        foreach ($chats as $chat): ?>
            <li class="messages__contacts-item">
                ...
                <a class="messages__contacts-tab messages__contacts-tab<?= $classname ?> tabs__item tabs__item"
                   href="messages.php?chat_id=<?= $chat['id'] ?>">
                    <div class="messages__avatar-wrapper">
                        <img class="messages__avatar" src="<?= get_user_avatar($chat['avatar']) ?>"
