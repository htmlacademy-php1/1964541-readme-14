        ...
        <div class="form__text-inputs-wrapper">
            <div class="form__text-inputs">
                ...
                <div class="adding-post__input-wrapper form__input-wrapper">
                    ...
                    <?php
                    $classname = isset($validation_errors['video']) ? 'form__input-section--error' : ''; ?>
                    <div class="form__input-section <?= $classname ?>">
                        <input class="adding-post__input form__input" id="video-url" type="text" name="video"
                               value="<?= getPostVal('video') ?>" placeholder="Введите ссылку">
                        <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span>
                        </button>
                        <div class="form__error-text">
                            <h3 class="form__error-title">Ошибка</h3>
                            <p class="form__error-desc"><?php
                                isset($validation_errors['video']) ? print $validation_errors['video'] : '' ?></p>
                        </div>
                    </div>
                </div>
