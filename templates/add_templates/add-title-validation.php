    ...
    <div class="form__input-section <?= $classname ?>">
        ...
        <div class="form__error-text">
            ...
            <p class="form__error-desc"><?php
                isset($validation_errors['title']) ? print $validation_errors['title'] : '' ?></p>
        </div>
    </div>
</div>
